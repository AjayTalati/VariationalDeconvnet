local SpatialZeroPaddingCUDA, parent = torch.class('nn.SpatialZeroPaddingCUDA', 'nn.Module')

function SpatialZeroPaddingCUDA:__init(pad_l, pad_r, pad_t, pad_b)
   parent.__init(self)
   self.pad_l = pad_l
...
function SpatialZeroPaddingCUDA:updateOutput(input)
   -- sizes
...
function SpatialZeroPaddingCUDA:updateGradInput(input, gradOutput)
