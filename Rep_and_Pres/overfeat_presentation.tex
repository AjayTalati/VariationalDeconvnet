...
\begin{itemize}
	\item Convolutional Networks have had much success recently in Computer Vision tasks on large datasets
	\item To date, there is no effective means of training such Networks unsupervised
	\item The recently developed SGVB makes efficient, effective Bayesian Inference possible by means of stochastic gradient descent
\end{itemize}
\end{frame}
