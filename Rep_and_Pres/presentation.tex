...
\To train the network with gradient descent, we need an optimization criterion. If we add a fully-connected layer to our convolutional network that connects to latent variables and reconstruct the input from threse latent variables through a "Deconvolutional" Network, we can calculate the lower bound of the likelihood of the data given our model and a prior over the weights
\end{frame}
