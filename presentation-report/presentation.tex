...
%describe the problem of upsampling and weight sharing
Option 1: for each resulting feature map, learn a weight matrix that creates an NxN window for each pixel in the feature maps of the previous layer.\\
requirements:
\begin{itemize}
